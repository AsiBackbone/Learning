...
| Audit lifecycle evidence | [Decision Receipt Observability Schema](https://github.com/AsiBackbone/AsiBackbone/blob/main/docs/articles/decision-receipt-observability-schema.md) | Structured decision and execution evidence suitable for correlation across lifecycle stages. |
...
| Audit lifecycle vocabulary | [`DecisionReceiptLifecycleStage`](https://github.com/AsiBackbone/AsiBackbone/blob/main/src/AsiBackbone.Core/Audit/DecisionReceiptLifecycleStage.cs) | Lifecycle-oriented audit stages that can participate in broader host-owned workflow evidence. |
