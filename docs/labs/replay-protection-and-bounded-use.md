...
- [`ICapabilityGrantUseStore`](https://github.com/AsiBackbone/AsiBackbone/blob/v7.0.0/src/AsiBackbone.Core/CapabilityGrants/ICapabilityGrantUseStore.cs) — compare the lab contract with the working framework seam.
- [`InMemoryCapabilityGrantUseStore`](https://github.com/AsiBackbone/AsiBackbone/blob/v7.0.0/src/AsiBackbone.Storage.InMemory/CapabilityGrants/InMemoryCapabilityGrantUseStore.cs) — inspect the working local reference provider and its limitations.
- [`InMemoryCapabilityGrantUseStoreTests`](https://github.com/AsiBackbone/AsiBackbone/blob/v7.0.0/tests/AsiBackbone.Core.Tests/CapabilityGrants/InMemoryCapabilityGrantUseStoreTests.cs) — compare local concurrency invariant coverage.
