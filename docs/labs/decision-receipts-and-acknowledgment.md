...
- [`AcknowledgmentRequest`](https://github.com/AsiBackbone/AsiBackbone/blob/main/src/AsiBackbone.Core/Acknowledgments/AcknowledgmentRequest.cs) — compare the teaching challenge with the fuller framework handshake request.
- [`AcknowledgmentResponse`](https://github.com/AsiBackbone/AsiBackbone/blob/main/src/AsiBackbone.Core/Acknowledgments/AcknowledgmentResponse.cs) — inspect the working accepted/rejected acknowledgment model.
