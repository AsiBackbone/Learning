...
- [AI Agent Gateway Scenario](https://github.com/AsiBackbone/AsiBackbone/blob/v7.0.0/docs/articles/scenarios/ai-agent-gateway.md) — compare the teaching gateway with the working framework's scenario documentation.
- [Human Approval Before AI Tool Execution](https://github.com/AsiBackbone/AsiBackbone/blob/v7.0.0/docs/articles/scenarios/human-approval-before-ai-tool-execution.md) — compare acknowledgment handling with the implementation-oriented guidance.
- [Capability Grant Hardening](https://github.com/AsiBackbone/AsiBackbone/blob/v7.0.0/docs/articles/capability-grant-hardening.md) — examine production-oriented proof, replay, time, binding, and failure considerations.
