---
description: Learn when simple application structure is enough, which signals justify new boundaries, and how to add layers without turning style into doctrine.
