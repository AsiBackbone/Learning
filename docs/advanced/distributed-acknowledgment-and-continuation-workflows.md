...
> **Illustrative API:** This local `AcknowledgmentChallenge` shape is a teaching model, not the `AsiBackbone.AspNetCore` package type. See the [AsiBackbone 7.0 Compatibility and API Boundary](../getting-started/asibackbone-7-api-boundary.md) before copying package-integration syntax.
