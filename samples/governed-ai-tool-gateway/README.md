...
- [AI Agent Gateway Scenario](https://github.com/AsiBackbone/AsiBackbone/blob/v7.0.0/docs/articles/scenarios/ai-agent-gateway.md)
- [Human Approval Before AI Tool Execution](https://github.com/AsiBackbone/AsiBackbone/blob/v7.0.0/docs/articles/scenarios/human-approval-before-ai-tool-execution.md)
